...
if (size > ARRAY_SIZE)
	...
	ARRAY_SIZE_MOD = ARRAY_SIZE;
cout << "the new size " << ARRAY_SIZE_MOD << endl;
	int listA[ARRAY_SIZE]/* = {0}*/; //variable sized array cannot be initialized
	int listB[ARRAY_SIZE_MOD];
	
	cout << "Line 1: listA elements: ";

	printArray(listA, ARRAY_SIZE_MOD);
	cout << endl;

	initializeArray(listB, ARRAY_SIZE_MOD);
	cout << "Line 5: listB elements: ";

	printArray(listB, ARRAY_SIZE_MOD);
	cout << endl << endl;

	cout << "Line 8: Enter " << ARRAY_SIZE_MOD << " integers: ";

	fillArray(listA, ARRAY_SIZE_MOD);
	cout << endl;
	...
	cout << "Line 14: The sum of the elements of "
		<< "ListA is: "
		<< sumArray(listA, ARRAY_SIZE_MOD) << endl
		<< endl;

	cout << "Line 15: The position of the smallest " 
		<< "element in listA is: "
		<< smallestIndex(listA, ARRAY_SIZE_MOD)
		<< endl;

	cout << "Line 16: The value of the smallest element "
		<< "ListA is: "
		<< listA[smallestIndex(listA, ARRAY_SIZE_MOD)]
		<< endl << endl;

//	copyArray(listA, listB, ARRAY_SIZE_MOD);
